...
import com.listview.muvi.databinding.FragmentUpcomingBinding
...
class UpcomingFragment : Fragment(), MovieAdapter.OnItemClickCallback {
    private var getBinding: FragmentUpcomingBinding? = null
    ...
    override fun onCreateView(
        ...
        getBinding = FragmentUpcomingBinding.inflate(layoutInflater)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.rvNowUpcoming?.layoutManager = layoutManager
        val itemDecoration = DividerItemDecoration(requireActivity(), layoutManager.orientation)
        binding?.rvNowUpcoming?.addItemDecoration(itemDecoration)
        findUpcoming()
    }
