...
class PopulerFragment : Fragment(), MovieAdapter.OnItemClickCallback {
    private var getBinding: FragmentPopulerBinding? = null
    ...
    override fun onCreateView(
        ...
        getBinding = FragmentPopulerBinding.inflate(layoutInflater)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.rvPopuler?.layoutManager = layoutManager
        val itemDecoration = DividerItemDecoration(requireActivity(), layoutManager.orientation)
        binding?.rvPopuler?.addItemDecoration(itemDecoration)
        findPopuler()
    }

    private fun findPopuler() {
        showLoading(true)
        val client = ApiConfig.getApiService().getPopuler()
